...
// Get API key from environment variables (Vercel) or use sandbox key as fallback
const API_KEY = process.env.OPENAI_API_KEY || 
                process.env.NEXT_PUBLIC_OPENAI_API_KEY || 
                'secret_cm915c66b00023b6r51yc9cw3';
...
async function _proxyOpenAI<T = any>(cfg: {
  ...
  console.log('🌐 Making OpenAI API request to:', path);
